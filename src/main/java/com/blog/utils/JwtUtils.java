...
public class JwtUtils {
     ...
     * @return
     */
    public String createJwt(Date exp , Map<String,String> payLoad){
        return Jwts.builder()
                .setClaims(payLoad)
...
//            e.printStackTrace();
     ...
     * @return
     */
    public Map<String,String> getPayLoad(String jwsString){
        try {
            return ((Map<String, String>) (parseJwtResultJws(jwsString)).getBody());
        }catch (Exception e){
            return null;
        }
    }
